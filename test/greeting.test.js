...
const greetingsFactory = require('../services/greetings-services');
const pg = require("pg");
const Pool = pg.Pool;
...
describe('The basic database web app', async function () {
    ...
    it('should not take duplicate on counter', async () => {
        var greetInstance = greetingsFactory(pool);
        beforeEach(async function () {
            // clean the tables before each test run
            await pool.query("delete from users;");
    ...
    it('should add new name on counter', async () => {
        var greetInstance = greetingsFactory(pool);
        beforeEach(async function () {
            // clean the tables before each test run
            await pool.query("delete from users;");
